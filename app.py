...
# Add donation button with larger size and style
st.markdown("""
<a href="https://buymeacoffee.com/vetfed" target="_blank">
    <button style="background-color: #FF5F5F; color: white; padding: 15px 30px; font-size: 18px; border-radius: 8px; margin-bottom: 30px; width: 100%;">Support Me on Buy Me a Coffee</button>
</a>
...
# Customize radio buttons to make them larger
st.markdown("""
    <style>
        .stRadio>div>label {
            font-size: 20px;
...
option = st.radio("Select a Calculator", ["🏖️ Annual Leave Lump Sum", "📅 Annual Leave Accrual", "💼 Severance Pay Estimation"], index=2)
